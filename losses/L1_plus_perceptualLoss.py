...
class L1_plus_perceptualLoss(nn.Module):
    def __init__(self, lambda_L1, lambda_perceptual, perceptual_layers, gpu_ids, percep_is_l1):
        ...
        vgg19.load_state_dict(torch.load('/media/alien/c44d249a-e622-42e6-bcb5-9bf635999267/Controllable_Person_Image_Synthesis_with_Attribute_Decomposed_GAN/deepfashion/vgg19-dcbb9e9d.pth'))
        vgg = vgg19.features
